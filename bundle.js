...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(2), __webpack_require__(0), __webpack_require__(20)) :
...
exports.default = _collection2.default.extend({
    ...
    initialize: function initialize(models, options) {
        var hasSecAccCodes = options.hasOwnProperty('secAccCodes');
        var hasSecAccUrls = options.hasOwnProperty('secAccUrls');
        var secAccMap = {};
        ...
        _collection2.default.prototype.initialize.call(this, models, _underscore2.default.extend(options, {
...
exports.default = _backbone2.default.Collection.extend({
    ...
    initialize: function initialize(models, options) {
        ...
        var hasInitStats = options.hasOwnProperty('initStats');
        ...
        this.stats = new _model2.default(options.initStats);
        ...
        this.listenTo(this, 'request', function () {
            _this.isCacheHit = false;
        });
        this.listenTo(this, 'cachesync', function () {
            _this.isCacheHit = true;
        });
    },
    ...
    parse: function parse(response) {
        this.stats.set(this.stats.parse(_underscore2.default.omit(response[this.rootProp], 'experiment')));
    ...
    fetch: function fetch(options) {
        ...
        fetched = _backbone2.default.Collection.prototype.fetch.call(this, options);
    ...
    relayEvents: function relayEvents(fetched, options) {
        var _this2 = this;

        this.stats.trigger('request', this.stats, fetched, options);
        fetched.done(function () {
            _this2.isFulfilled = true;
            _this2.stats.trigger('sync', _this2.stats, _this2.stats.toJSON(), options);
        }).fail(function () {
            _this2.stats.trigger('error', _this2.stats, _this2.stats.toJSON(), options);
            console.log('Error while retrieving ' + _this2.rootProp);
        });
    },
    ...
    sync: function sync(method, collection, options) {
        ...
        this.lastSynced = _backbone2.default.Collection.prototype.sync.call(this, method, collection, options);
...
exports.default = _backbone4.default.View.extend({
    ...
    onRender: function onRender() {
        var isEmpty = !this.model.get('total');
        var isSingle = this.model.get('total') == 1;
...
var _empty = __webpack_require__(29);

var _empty2 = _interopRequireDefault(_empty);

var _idle = __webpack_require__(30);

var _idle2 = _interopRequireDefault(_idle);

var _view3 = __webpack_require__(6);
...
var _view5 = __webpack_require__(18);

var _view6 = _interopRequireDefault(_view5);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EmptyExp = _backbone4.default.View.extend({
    /* DATA */
...
exports.default = _view6.default.extend({
    childView: _view2.default,
    emptyView: EmptyExp, //Used for the idle state too (no request made yet).

    initialize: function initialize(options) {
        _view6.default.prototype.initialize.call(this, options);

        if (this.results instanceof _collection2.default) {
        ...
        this.listenTo(_backbone2.default, 'window:resize', this.setDims);
    ...
    onLoad: function onLoad() {
        this.setDims();
        !this.isEmpty() && this.children.each(function (expView) {
    ...
    setDims: function setDims() {
        var windowHeight = window.innerHeight;
        this.children.each(function (expView) {
    ...
    onReorder: function onReorder() {
        ...
        this.children.each(function (expView) {
            expView.highlightSortEl(_this.currSortAttr);
            expView.fetchIfVisible();
        });
    },

    //Instantiates stats view using the experiments' stats
    getStatsView: function getStatsView() {
...
exports.default = _backbone4.default.View.extend({
    ...
    initialize: function initialize(options) {
        var hasCollection = options.hasOwnProperty('collection');
        var hasModel = options.hasOwnProperty('model');
    ...
    searchOnEnter: _underscore2.default.debounce(function (event) {
        if (event.keyCode == 13) {
            this.search(this.getQuery());
        }
    }, 250),

    searchOnClick: _underscore2.default.debounce(function (event) {
        this.search(this.getQuery());
    }, 250),

    searchOnRoute: function searchOnRoute(query) {
    ...
    getQuery: function getQuery() {
        var fieldValue = this.fieldEl.value.trim().replace(/\s+/g, ' ');
    ...
    search: function search(query) {
        ...
        var isError = !results.isFulfilled;
        ...
        if (!this.isBlankQuery && (this.isNewQuery || isError)) {
            ...
            results.fetch({
                ...
                success: function success(results) {
                    !results.length && _this.fieldEl.focus();
                }
            });
        }
    },
...
exports.default = function () {
    var emailDef = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var waitDelay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;

    return _backbone4.default.View.extend({
        template: _template2.default,
...
(function (root, factory) {
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(2), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone, $) {
...
exports.default = _backbone2.default.Model.extend({
    ...
    parse: function parse(response) {
        ...
        var hasSecAcc = response.hasOwnProperty('secondaryaccession');
    ...
    sortAccPriority: function sortAccPriority(secAccs) {
        var _this = this;

        secAccs.forEach(function (secAcc, index) {
            var priorIndex = void 0;

            if (index) {
                priorIndex = _this.secAccMap[secAccs[index - 1].slice(0, 3)];
                if (priorIndex > _this.secAccMap[secAcc.slice(0, 3)]) {
    ...
    getSecAccUrls: function getSecAccUrls(secAccs) {
        var _this2 = this;

        var urls = [];

        secAccs.forEach(function (secAcc) {
            var code = secAcc.slice(0, 3);
            urls.push(_this2.secAccUrls[_this2.secAccMap[code]] + secAcc);
        });
        return urls;
    }
});
...
exports.default = _backbone4.default.View.extend({
    ...
    templateContext: function templateContext() {
        ...
        return {
            ...
            //shortens it.
            truncDescription: function truncDescription() {
            ...
            fixedDescription: function fixedDescription() {
                var sanitised = this.description[0].text.replace(/<\/br>/gi, '');
                return sanitised.replace(/href/g, 'rel="external" href');
            },

            //Shortens the name of the experiment.
            truncName: function truncName() {
    ...
    truncStr: function truncStr(string) {
        var charLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.options.descCharLimit;
    ...
    onRender: function onRender() {
        var fileStatsEl = this.el.querySelector('.experiment-files');
        var expAccession = this.model.get('accession');
        ...
        var statsEl = new _view2.default({
            model: files.stats,
        ...
        this.listenTo(_backbone2.default, 'window:scroll', this.fetchIfVisible);
        this.listenTo(_backbone2.default, 'window:resize', this.fetchIfVisible);
    ...
    highlightSortEl: function highlightSortEl(sortAttr) {
        var activeClass = this.options.activeClass;
        var currActiveEl = this.sortAttrs[0];
...
exports.default = _collection2.default.extend({
    ...
    fetch: function fetch() {
        ...
        var currSuccess = options.success;

        options.success = function (collection, response, fetchOpts) {
            _this2.setStats('processed');
            _this2.setStats('raw');
            _this2.isFetched = true;
            currSuccess && currSuccess(collection, response, fetchOpts);
        };

        return _collection2.default.prototype.fetch.call(this, options);
    },

    //Works out file totals for the stats model and the map of files by category
    setStats: function setStats(typeFile) {
        var files = this.where({ kind: typeFile });
...
exports.default = _backbone2.default.Model.extend({
    ...
    parse: function parse(response) {
        if (Array.isArray(response.kind)) {
            response.kind = _underscore2.default.find(response.kind, function (kind) {
...
exports.default = _view2.default.extend({
    ...
    initialize: function initialize(options) {
        var hasFileRoot = options.hasOwnProperty('fileRoot');
        var hasSecAccCode = options.hasOwnProperty('secAccCode');
        var hasSecAccUrl = options.hasOwnProperty('secAccUrl');
    ...
    templateContext: function templateContext() {
        var fileRoot = this.options.fileRoot;
        var secUrl = this.options.secAccUrl;
        var secCode = this.options.secAccCode;
        var stats = this.model;

        return {
            url: function url(typeFile) {
                var total = stats.getTotal(typeFile);
            ...
            linkClass: function linkClass(typeFile) {
                var total = stats.getTotal(typeFile);
...
exports.default = _backbone4.default.CollectionView.extend({
    ...
    initialize: function initialize(options) {
        ...
        var hasSortAttr = opts.hasOwnProperty('defaultSortAttr');
        var hasDirection = opts.hasOwnProperty('defaultSortDir');
        var hasChildOpts = opts.hasOwnProperty('childViewOptions');
        ...
        if (hasChildOpts) {
            this.childViewOptions = _underscore2.default.defaults(opts.childViewOptions, this.__proto__.childViewOptions);
        }
    },
    ...
    viewComparator: function viewComparator(res1, res2) {
        var res1value = this.scalar(res1.get(this.currSortAttr));
        var res2value = this.scalar(res2.get(this.currSortAttr));
        var lacksAttr = typeof res1value === 'undefined' || typeof res2value === 'undefined';
    ...
    sort: function sort(event) {
        var newSortAttr = event.currentTarget.dataset.attribute;
...
exports.default = _backbone2.default.Model.extend({
    ...
    camelise: function camelise(propName) {
        return propName.replace(/-([a-z])/g, function (hump) {
            return hump[1].toUpperCase();
        });
    },

    setTotal: function setTotal(value) {
        var totalName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

        if (totalName) {
            this.set('total' + _underscore2.default.capitalise(totalName), value);
    ...
    getTotal: function getTotal() {
        var totalName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

        if (totalName) {
            return this.get('total' + _underscore2.default.capitalise(totalName));
        } else {
            return this.get('total');
        }
    },

    purgeLastTotal: function purgeLastTotal() {
        this.set('total', 0);
    }
});
...
with(obj||{}){
__p+='<article class="experiment empty">\n    <h1>Your search - <strong>&quot;'+
((__t=( query ))==null?'':__t)+
'&quot;</strong> - did not match any experiments.</h1>\n    <p>Suggestions</p>\n    <ul>\n        <li>Verify the keywords used. Is it the right accession number, for example?</li>\n        <li>Try different keywords. How about words in the experiment\'s title?</li>\n        <li><a class="email" href="'+
((__t=( encodeURI('mailto:' + email + '?Subject=ArrayExpress v' + apiVersion + '.' + apiRevision + ' - Unmatched query: "' + query + '"') ))==null?'':__t)+
'">Contact us </a> if the query refers to an experiment that should be included in the database.</li>\n    </ul>\n</article>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<article class="experiment empty">\n    <h1>Enter one or multiple keywords in the search box above. <a rel="external" target="_blank" href="'+
((__t=( helpUrl ))==null?'':__t)+
'">More help</a></h1>\n    <p>Suggestions: </p>\n    <ul>\n        <li><a class="internal" href="#Geuvadis">Geuvadis</a></li>\n        <li><a class="internal" href="#E-MEXP-31">E-MEXP-31</a></li>\n        <li><a class="internal" href="#p40">p40</a></li>\n    </ul>\n</article>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<article class="experiment single">\n    <h1 class="experiment-entry">'+
...
')</dt>\n                <dd><a rel="external" href="'+
((__t=( experimentUrl ))==null?'':__t)+
'/'+
((__t=( accession ))==null?'':__t)+
...
__p+='\n                    <p>\n                        <cite><a rel="external" href="http://dx.doi.org/'+
((__t=( citation.doi ))==null?'':__t)+
'">'+
...
((__t=( url ))==null?'':__t)+
'">'+
((__t=( secondaryaccession[index] ))==null?'':__t)+
'</a></li>\n                    ';
 }) 
__p+='\n                    <li><a rel="external" href="'+
((__t=( experimentUrl ))==null?'':__t)+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<article class="experiment">\n    <h1 class="experiment-entry">\n        <cite class="sortable" data-attribute="accession" title="Click to sort by accession">'+
((__t=( accession ))==null?'':__t)+
...
'\n        </p>\n        <dl>\n            ';
 if (hasType) { 
__p+='\n            <div>\n                <dt class="sortable" data-attribute="experimenttype" title="Click to sort by experiment type">Type:</dt>\n                <dd>'+
...
((__t=( total ))==null?'':__t)+
'</strong> experiments:\n<strong>'+
((__t=( totalAssays ))==null?'':__t)+
'</strong> assays, \n<strong>'+
((__t=( totalSamples ))==null?'':__t)+
'</strong> samples';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<strong>Files</strong>\n<span class="link-container">\n    <a rel="external" href="'+
((__t=( url('processed') ))==null?'':__t)+
'" class="'+
((__t=( linkClass('processed') ))==null?'':__t)+
'">\n        '+
((__t=( totalProcessed ))==null?'':__t)+
' processed\n    </a>\n</span>\n<span class="link-container">\n    <a rel="external" href="'+
((__t=( url('raw') ))==null?'':__t)+
'" class="'+
((__t=( linkClass('raw') ))==null?'':__t)+
'">\n        '+
((__t=( rawCount() ))==null?'':__t)+
' raw\n    </a>\n</span>\n';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="spinner"></div>\n<p class="wait-msg">Please wait while all results are retrieved. You may cancel at any time by performing a new search.</p>\n<dl class="error-msg">\n    <dt>Server error</dt> \n    <dd><p>Maybe you are offline? \n      ';
 if (email) { 
__p+='\n        If not, please contact <a class="email" href="'+
((__t=( encodeURI('mailto:' + email + '?Subject=ArrayExpress - Request failure') ))==null?'':__t)+
'">the support team</a>.\n      ';
 } 
__p+='\n    </p></dd>\n</dl>';
}
...
var _view3 = __webpack_require__(7);

var _view4 = _interopRequireDefault(_view3);

var _view5 = __webpack_require__(9);
...
var Search = _backbone4.default.Application.extend({
    ...
    onBeforeStart: function onBeforeStart(app, options) {
        ...
        window.addEventListener('scroll', _underscore2.default.throttle(function () {
            _backbone2.default.trigger('window:scroll');
        }), 300);
        window.addEventListener('resize', _underscore2.default.debounce(function () {
            _backbone2.default.trigger('window:resize');
        }), 400);
    ...
    onStart: function onStart(app, options) {
        ...
        var LoadingWithEmail = (0, _view6.default)(options.supportEmail, options.waitDelay * 1000);
        ...
        var listView = new _view4.default({
            collection: this.results,
            childViewOptions: {
...
var search = new Search().start({
    ...
    'http://www.ebi.ac.uk/ena/data/view/', 'http://www.ebi.ac.uk/ena/data/view/', 'https://www.ebi.ac.uk/ega/studies/', 'https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=']
});
