...
exports.default = _backbone2.default.Collection.extend({
    ...
    fetch: function fetch(options) {
        ...
        fetched.done(function () {
            ...
            _this.stats.trigger('sync', _this.stats, _this.stats.toJSON(), options);
        }).fail(function () {
            _this.stats.trigger('error', _this.stats, _this.stats.toJSON(), options);
            console.log('Error while retrieving ' + _this.rootProp);
        });
...
exports.default = _backbone4.default.View.extend({
    ...
    onRender: function onRender() {
        ...
        this.listenTo(_backbone2.default, 'visibility:check', this.fetchIfAbove.bind(this));
    ...
    fetchIfAbove: function fetchIfAbove() {
        var isAboveFold = this.el.getBoundingClientRect().top < window.innerHeight;
        var files = this.collection;

        if (!files.isBusy && !files.isFetched && isAboveFold) {
            files.fetch({ cache: true, expires: this.options.cacheExpiry });
            this.stopListening(_backbone2.default);
        }
    },
...
exports.default = _backbone2.default.Model.extend({
    ...
    capitalise: function capitalise(propName) {
...
'</cite>:\n        <a rel="external" href="'+
((__t=( experimentUrl + '/' + accession ))==null?'':__t)+
'">\n            '+
...
__p+='<div class="spinner"></div>\n<p class="wait-msg">Please wait while all results are retrieved. You may cancel at any time by performing a new search.</p>\n<dl class="error-msg">\n    <dt>Server error</dt> \n    <dd><p>Maybe you are offline? \n      ';
 if (email) { 
__p+='\n        If not, please contact <a rel="external" href="'+
    ...
    onBeforeStart: function onBeforeStart(app, options) {
        ...
        window.addEventListener('scroll', _underscore2.default.throttle(function () {
            _underscore2.default.defer(function () {
                _backbone2.default.trigger('visibility:check');
            });
        }), 300);
